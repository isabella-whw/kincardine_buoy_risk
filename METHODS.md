...
&nbsp;   total\_score = wave\_factor + period\_factor + wind\_factor
...
\- \*\*Low Risk:\*\* total\_score < 4

\- \*\*Moderate Risk:\*\* 4 ≤ total\_score ≤ 7

\- \*\*High Risk:\*\* total\_score > 7
