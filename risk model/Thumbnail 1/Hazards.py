...
from Thumbnail import pred_haz
...
tbl3 = df_full.groupby("risk_level")[["wave_height_m", "max_wave_height_12h_m", "wave_period_s"]].mean().round(2).reindex(class_order)
...
with PdfPages(pdf_filename) as pdf:
    ...
    pair = sns.pairplot(
        df_full,
        vars=["wave_height_m", "max_wave_height_12h_m", "wave_period_s", "total_score"],
        hue="risk_level",
        palette={
            "Low": "green",
            "Moderate": "orange",
