...
from Thumbnail3_rescaled import pred_haz


# ------------------------------------------------------------
# Load and prepare data
df = pd.read_csv("NOAA_2019to2024_predictions_6h.csv")
...
tbl3 = df_full.groupby("risk_level")[["wave_height_m", "wave_period_s", "wind_speed_ms", "max_wave_height_6h_m"]].mean().round(2).reindex(class_order)
...
with PdfPages(pdf_filename) as pdf:
    ...
    pair = sns.pairplot(
        df_full,
        vars=["wave_height_m", "max_wave_height_6h_m", "wave_period_s", "wind_speed_ms", "total_score"],
        hue="risk_level",
        palette={
            "Low": "green",
            "Moderate": "orange",
