...
tbl3 = df_full.groupby("risk_level")[["wave_height_m", "wave_period_s", "wave_dir_deg", "wind_speed_ms", "wind_dir_deg", "total_score"]].mean().round(2).reindex(class_order)
...
with PdfPages(pdf_filename) as pdf:
    ...
    ymax = max(df_full["total_score"].max(), 3)
    ...
    pair = sns.pairplot(
        df_full,
        vars=["wave_height_m", "wave_period_s", "wave_dir_deg", "wind_speed_ms", "wind_dir_deg", "total_score"],
        hue="risk_level",
        palette={
            "Low": "green",
            "Moderate": "orange",
